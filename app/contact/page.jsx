...
export default function ContactPage() {
  ...
  function validate() {
    ...
    if (!form.message.trim() || form.message.trim().length < 8) e.message = "Message must be at least 8 characters.";
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        ...
        <SectionMotion>
          <div className="text-center mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold mt-4 mb-2" style={{ color: "#f8fafc" }}>
              Contact Sai Kalyan Associates
            </h1>
            <p className="max-w-2xl mx-auto text-slate-400">
              For document drafting, registration, NRI support or quick advice — reach out and we’ll respond within 24–48 hours.
            </p>
          </div>
        </SectionMotion>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7">
            <SectionMotion delay={0.05}>
              <div className="p-[1px] rounded-2xl mb-6" style={{ backgroundImage: "linear-gradient(135deg,#4f46e5 0%,#ec4899 100%)" }}>
                <div className="bg-[#06070a] rounded-2xl p-6 md:p-8 border border-white/10">
                  <h2 className="text-2xl font-bold text-white mb-2">Send us a message</h2>
                  <p className="text-slate-400 mb-4">Tell us briefly what you need and we'll call or email you back.</p>

                  <form onSubmit={handleSubmit} noValidate>
                    <input name="hp" value={form.hp} onChange={(e)=>update("hp", e.target.value)} style={{ display: "none" }} tabIndex={-1} autoComplete="off" />

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <label className="flex flex-col">
                        <span className="text-xs text-slate-300 mb-1">Name</span>
                        <input
                          value={form.name}
                        ...
                        />
                        {errors.name && <span id="err-name" className="text-xs text-rose-400 mt-1">{errors.name}</span>}
                      </label>
                      ...
                      <label className="flex flex-col">
                        ...
                        />
                        {errors.email && <span id="err-email" className="text-xs text-rose-400 mt-1">{errors.email}</span>}
                      </label>
                    </div>

                    <div className="mt-3">
                      <label className="flex flex-col">
                        <span className="text-xs text-slate-300 mb-1">Phone</span>
                        <input
                          value={form.phone}
                        ...
                        />
                        {errors.phone && <span id="err-phone" className="text-xs text-rose-400 mt-1">{errors.phone}</span>}
                      </label>
                    </div>

                    <div className="mt-3">
                      <label className="flex flex-col">
                        <span className="text-xs text-slate-300 mb-1">Message</span>
                        <textarea
                          value={form.message}
                        ...
                        />
                        {errors.message && <span id="err-message" className="text-xs text-rose-400 mt-1">{errors.message}</span>}
                      </label>
                    </div>
                    ...
                    <div className="mt-4 flex items-center gap-3">
                      <button
                        ...
                        style={{ background: status.loading ? "linear-gradient(90deg,#a78bfa,#fb7185)" : "linear-gradient(90deg,#4f46e5,#ec4899)", color: "#fff" }}
                      >
                    ...
                    <div className="mt-3 min-h-[1.25rem] text-sm" role="status" aria-live="polite">
                      {status.ok === true && <div className="text-emerald-400">{status.msg}</div>}
                      {status.ok === false && <div className="text-rose-400">{status.msg}</div>}
                    </div>
                  </form>
                </div>
              </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <SectionMotion delay={0.08}>
              <div className="p-[1px] rounded-2xl" style={{ backgroundImage: "linear-gradient(135deg,#4f46e5 0%,#ec4899 100%)" }}>
                <div className="bg-[#06070a] rounded-2xl p-6 border border-white/10">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-white">+91 88972 03663</div>
                        <div className="font-semibold text-white">+91 91773 05608</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-white">saikalyan17171@gmail.com</div>
                        <div className="font-semibold text-white">saikalyanagency14@gmail.com</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-white">Mon — Sat: 9:30 AM — 7:30 PM</div>
                        <div className="text-slate-400 text-sm">Closed on Sundays & public holidays</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 flex gap-3">
                    <a href="https://www.instagram.com/shiva_drithi?igsh=dXdha2c0c3VvcjZn&utm_source=qr" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/6 hover:bg-white/8">
                      <Instagram className="w-4 h-4 text-pink-400" /> <span className="text-sm text-slate-100">Instagram</span>
                    </a>
                    <a href="https://www.facebook.com/share/1GwBME8XvD/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/6 hover:bg-white/8">
                      <Facebook className="w-4 h-4 text-indigo-400" /> <span className="text-sm text-slate-100">Facebook</span>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <SectionMotion delay={0.16}>
              <div className="rounded-2xl p-4 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.03)] text-sm">
                ...
                <ul className="mt-2 space-y-2 text-slate-300">
                  <li><strong>How long to prepare documents?</strong> Typically 1–3 business days depending on the service and verification needs.</li>
                  <li><strong>Do you represent at Sub-Registrar?</strong> Yes — we represent clients for registration and follow-up in Hyderabad.</li>
                </ul>
              </div>
            </SectionMotion>
          </div>
